...
#[derive(Clone)]
pub struct TemplateProfessionWeaponProcessor<TArmamentProcessor, TSkillProcessor>
where
...
impl<TArmamentProcessor, TSkillProcessor>
    TemplateProfessionWeaponProcessor<TArmamentProcessor, TSkillProcessor>
where
    TArmamentProcessor: LeveledCreatureProcessor + Default,
    TSkillProcessor: LeveledCreatureProcessor + Default,
{
...
impl<TArmamentProcessor, TSkillProcessor> Default
    for TemplateProfessionWeaponProcessor<TArmamentProcessor, TSkillProcessor>
where
    TArmamentProcessor: LeveledCreatureProcessor + Default,
    TSkillProcessor: LeveledCreatureProcessor + Default,
{
